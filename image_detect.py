...
class YOLO(object):
    _defaults = {
        ...
        "classes_path": 'model_data/table_classes.txt', #'4_CLASS_test_classes.txt',
        "score" : 0.3,
        "iou" : 0.45,
    ...
    def detect_image(self, image):
        ...
        for i, c in reversed(list(enumerate(out_classes))):
            ...
            mid_v = (bottom-top)/2+top #mid_h
            mid_h = (right-left)/2+left #mid_v
            ...
            ObjectsList.append([left, top, right, bottom, mid_h, mid_v, label, scores])
...
if __name__=="__main__":
    yolo = YOLO()
    #image = 'POD_0551.jpg'#'hydrant.jpg'
    #filename=os.path.splitext(image)[0]
    #print(filename)
    image = sys.argv[1]
    print ('input image filename:',image)
    ...
    #add by stephen
    cv2.waitKey(0)
    processed_fname ='detected_' + image
    print(processed_fname)
    cv2.imwrite(processed_fname,r_image)
